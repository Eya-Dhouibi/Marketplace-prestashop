 ...
 */
use PrestaShop\PrestaShop\Adapter\SymfonyContainer\Translator;
...
class MailAlert extends ObjectModel
{
    ...
    public static function sendCustomerAlert($id_product, $id_product_attribute)
    {
        ...
        $template_vars['{association_name}'] = $customer['association_name'];
        $template_vars['{association_email}'] = $customer['association_email'];
    }
