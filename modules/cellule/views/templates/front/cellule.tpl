   ...
   {if $cellule.valid == 1}
      <div class="js-cellule col-sm-3 cellule-box">
        <a href="" class="thumbnail cellule-thumbnail">
          <img src="/prestashop/img/cellule_logo/{$cellule.logo}" alt="logo" loading="lazy" style="width:150px;"/>
        </a>
        ...
        {block name='cellule_description'}
          <div class="cellule-description">
            <ul class="cellule-view">
              <li>
                <h6>{l s='Email :' mod='cellule'}</h6>
                <p>{$cellule.email}</p>
              </li>
              <li>
                <h6>{l s='Téléphone :' mod='cellule'}</h6>
                <p>{$cellule.telephone}</p>
              </li>
              <li>
                <h6>{l s='Adresse :' mod='cellule'}</h6>
                <p>{$cellule.adresse}</p>
              </li>
            </ul>
