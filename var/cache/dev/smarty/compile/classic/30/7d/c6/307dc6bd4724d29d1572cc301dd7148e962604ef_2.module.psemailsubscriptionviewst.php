...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_6460d0b4283852_47984579',
...
function content_6460d0b4283852_47984579 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- begin C:\laragon\www\prestashop/themes/classic/modules/ps_emailsubscription/views/templates/hook/ps_emailsubscription.tpl -->
...
">
  <div class="row">
    <h1 id="block-newsletter-label" class="col-md-12 col-xs-12"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'INSCRIVEZ-VOUS A NOTRE NEWSLETTER','d'=>'Shop.Theme.Global'),$_smarty_tpl ) );?>
</h1>
    <div class="col-xs-12">
...
" method="post">
        <div class="row">
          <div class="col-xs-12">
            <input
              class="btn btn-suscrire float-xs-right hidden-xs-down"
              name="submitNewsletter"
              type="submit"
              value="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'SOUSCRIRE','d'=>'Shop.Theme.Actions'),$_smarty_tpl ) );?>
"
            >
            <input
...
<!-- end C:\laragon\www\prestashop/themes/classic/modules/ps_emailsubscription/views/templates/hook/ps_emailsubscription.tpl --><?php }
}
