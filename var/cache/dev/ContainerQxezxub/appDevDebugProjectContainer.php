    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                53 => ($this->targetDirs[3].'/modules/ps_bestsellers/translations'),
                54 => ($this->targetDirs[3].'/modules/ps_newproducts/translations'),
                55 => ($this->targetDirs[3].'/modules/ps_specials/translations'),
                56 => ($this->targetDirs[3].'/modules/blockreassurance/translations'),
                57 => ($this->targetDirs[3].'/modules/cellule/translations'),
            ]; break;
