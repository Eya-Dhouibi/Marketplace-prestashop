...
/* @Modules/cellule/views/templates/admin/grid.html.twig */
class __TwigTemplate_f46a960f4cfec82a8d771ba83130dfaa08adc47a3aa9f8b3fc31e6667b5a675a extends \Twig\Template
{
...
";
        ...
        echo "          <div class=\"col-sm\">
            <div class=\"row\">
              <div class=\"col-sm\">
                ";
        // line 34
        echo twig_include($this->env, $context, "@PrestaShop/Admin/Common/Grid/Blocks/bulk_actions.html.twig", ["grid" => ($context["celluleGrid"] ?? null)]);
        echo "
              </div>
            </div>
          </div>
    ...
    public function block_grid_table_row($context, array $blocks = [])
    {
        ...
        <div class=\"col-sm\">
          ";
        // line 45
        echo twig_include($this->env, $context, "@Modules/cellule/views/templates/admin/cellule_table.html.twig", ["grid" => ($context["celluleGrid"] ?? null)]);
        echo "
        </div>
      </div>
    ";
    ...
    public function block_grid_footer_row($context, array $blocks = [])
    {
        ...
        <div class=\"col\">
          ";
        // line 53
        echo twig_include($this->env, $context, "@PrestaShop/Admin/Common/Grid/Blocks/pagination.html.twig", ["grid" => ($context["celluleGrid"] ?? null)]);
        echo "
        </div>
      </div>
    ";
    ...
    {
        return "@Modules/cellule/views/templates/admin/grid.html.twig";
    }
    ...
    {
        return new Source("", "@Modules/cellule/views/templates/admin/grid.html.twig", "C:\\laragon\\www\\prestashop\\modules\\cellule\\views\\templates\\admin\\grid.html.twig");
    }
}
