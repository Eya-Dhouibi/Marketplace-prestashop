...
<div class="block-contact col-md-3 links wrapper">
  ...
  <p class="h4 text-uppercase block-contact-title hidden-sm-down">{l s='CONTACTEZ-NOUS' d='Shop.Theme.Global'}</p>
  ...
  <div class="row">
      ...
      <div class="mb-0">
         ...
         {if isset($contact_infos.address)}
          {* [1][/1] is for a HTML tag. *}
          {l s='ADRESSE: [1]%adress%[/1]'
            sprintf=[
            '[1]' => '<span>',
            '[/1]' => '</span>',
            '%address1%' => $contact_infos.address
            ]
            d='Shop.Theme.Global'
          }
        {/if}
